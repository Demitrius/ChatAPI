...
ACC.L[1] = 'Имя пользователя / Емейл';
ACC.L[2] = 'Пароль';
ACC.L[3] = 'Войти';
...
ACC.L[548] = 'Внимание! Некоторые устройства запрещают показ уведомлений по умолчанию. Включается опция в системных настройках уведомлений или приложения.';
